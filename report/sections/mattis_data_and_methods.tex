...
where $x_{y,r}$ denotes the performance of rank $r$ in year $y$, and $|P| = 5$ represents the number of years per period. Changes in the performance gap are reported as the relative percentage difference between the two periods. Statistical significance was determined, as detailed in Section \ref{subsec:covid_analysis}, using the Mann-Whitney U test for the median and bootstrap resampling for the performance gap.
...
Due to regulatory changes in hurdle heights and throwing implement weights, particularly affecting U18 and U20 categories \citep{ProgressionWorldAthletics}, the respective disciplines were excluded from median- and rank-based analyses. Performance gap analyses were retained, as this metric can be calculated independently of the absolute values.