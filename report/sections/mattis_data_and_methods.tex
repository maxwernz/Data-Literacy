...
where $x_{y,r}$ denotes the performance of rank $r$ in year $y$, and $|P| = 5$ represents the number of years per period. Changes in the performance gap are reported as the relative percentage difference between the two periods.
