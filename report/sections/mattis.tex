...
The analysis of the performance data encompasses 106 groups, where X groups were excluded for median calculations (see \ref{sec:methods}. Overall, a decrease in performance density is evident. The best performers are improving, while the weaker performers are declining.
...
The results indicate a systematic increase in performance dispersion, particularly among men and young athletes. A major reason for this could be the 11.9\% decline in DLV memberships (2005–2024) \citep{LeichtathletikPortalDownloads}, with a more pronounced decrease of 26.6\% in the 27-to 60-year-old age group. This reflects a decline in the number of coaches, who are often found in this age group. Technical disciplines, in particular, are feeling the effects due to their higher reliance on individual athletes, which could also explain their declining performance density. In contrast, women's athletics shows more improvements, which is probably due to a "catch-up effect" as a result of historically delayed professionalization.
...
The polarization and the linear trend (see Fig X) could also be explained by the overall professionalization of the sport... TODO
